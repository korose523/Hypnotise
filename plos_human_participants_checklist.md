...
| 12 | Data availability | All underlying data are public (manuscript Data Availability Statement); code at Zenodo https://doi.org/10.5281/zenodo.21531272 (concept DOI; v1.0.14 versioned record https://doi.org/10.5281/zenodo.21933675) and GitHub https://github.com/korose523/Hypnotise (tag v1.0.14). |
...
*Prepared in accordance with PLOS human-participants research disclosure policy. All statements are consistent with the manuscript (`paper_en_submission_v6.docx`) and its ethics statement (§3.7).*
